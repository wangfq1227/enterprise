...
<head>
    ...
    <link rel="stylesheet" href="<%=path%>/resource/bootstrap-3.3.5/css/bootstrap.css">
    <link rel="stylesheet" href="<%=path%>/resource/bootstrap-3.3.5/css/bootstrap.min.css">
    ...
    <script type="text/javascript" src="<%=path%>/resource/bootstrap-3.3.5/js/bootstrap.js"></script>
</head>
